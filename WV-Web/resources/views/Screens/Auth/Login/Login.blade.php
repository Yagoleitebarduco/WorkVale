...
<body class="bg-linear-to-t from-Primary-light to-gray-100 font-sans">
        ...
        <div class="login-container max-w-md w-full relative z-10">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form id="loginForm">
                    ...
                    <!-- Botão Login -->
                    <button type="submit" class="bg-linear-to-r from-Primary-dark to-Primary w-full py-3 rounded-xl text-white font-semibold text-base hover:transform hover:-translate-y-0.5 transition duration-200 ease-in-out hover:shadow-2xl hover:-translate-x-0.5">
                ...
                <div class="text-center mt-6 pt-4 border-t border-gray-100">
                    <p class="text-sm text-gray-600">
                        Não tem uma conta?
                        <a href="{{ route('register.freelancer') }}" id="signupLink" class="font-semibold py-1rounded-2xl text-Primary-dark hover:text-Dark transition-all duration-200">
                            Cadastre-se
                        </a>
                    </p>
